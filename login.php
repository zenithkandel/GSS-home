            ...
            <div class="brand-content">
                <a href="index.html" class="brand-logo">
                    <svg class="logo-icon" viewBox="0 0 40 40" fill="none">
                        ...
                        <circle cx="20" cy="20" r="10" stroke="currentColor" stroke-width="2" fill="none" opacity="0.6"/>
                        <circle cx="20" cy="20" r="16" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.3"/>
                    </svg>
                    <span>LifeLine</span>
                </a>
                ...
                <div class="brand-illustration">
                    <svg viewBox="0 0 300 200" class="network-svg">
                        <!-- Connection lines -->
                        <g class="connections">
                            <line x1="50" y1="100" x2="150" y2="60" stroke="currentColor" stroke-width="1" opacity="0.2"/>
                            <line x1="150" y1="60" x2="250" y2="100" stroke="currentColor" stroke-width="1" opacity="0.2"/>
                            <line x1="50" y1="100" x2="150" y2="140" stroke="currentColor" stroke-width="1" opacity="0.2"/>
                            <line x1="150" y1="140" x2="250" y2="100" stroke="currentColor" stroke-width="1" opacity="0.2"/>
                            <line x1="150" y1="60" x2="150" y2="140" stroke="currentColor" stroke-width="1" opacity="0.2"/>
                        </g>
